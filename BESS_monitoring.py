...
BESSSOC = float( cympy.study.QueryInfoDevice('BESSSOC', BESS.DeviceNumber, cympy.enums.DeviceType.BESS, 6 ) )
BESSMaxSOC = float( cympy.study.QueryInfoDevice('BESSMaxSOC', BESS.DeviceNumber, cympy.enums.DeviceType.BESS, 6 ) )
BESSMinSOC = float( cympy.study.QueryInfoDevice('BESSMinSOC', BESS.DeviceNumber, cympy.enums.DeviceType.BESS, 6 ) )
BESSMaxChargPower = float( cympy.study.QueryInfoDevice('BESSMaxChargPower', BESS.DeviceNumber, cympy.enums.DeviceType.BESS, 6 ) )
BESSMaxDiscPower = float( cympy.study.QueryInfoDevice('BESSMaxDiscPower', BESS.DeviceNumber, cympy.enums.DeviceType.BESS, 6 ) )
BESSConverterRating = float( BESS.GetValue('Converter.ActivePowerRating') )

# Get the monitored active power of the selected Spot Load
Pload = float(cympy.study.QueryInfoDevice('KWTOT', spotLoadID, cympy.enums.DeviceType.SpotLoad, 6 ) )
