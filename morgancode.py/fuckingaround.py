        ...
        if request.is_json:
            try:
                ...
                if my_info['type'] == "record.create":
                    ...
                    print("Lat and Lon are: ", my_info['data']['created_latitude'], my_info['data']['created_longitude']) #evdits

#issue - latitude and longitude are empty to this script. how did he pass it over before???

                    #Assign lat, lon, and id values
                    lat = my_info['data']['created_latitude']
                    lon = my_info['data']['created_longitude']
                    record_id = my_info['data']['resource_id']
